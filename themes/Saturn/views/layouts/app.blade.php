...
<head>
    ...
    <style>
        ...
        .dark {
            --secondary-50: {{ config('settings::theme:secondary-50-dark', '#18181B') }};
            --secondary-100: {{ config('settings::theme:secondary-100-dark', '#313441') }};
            --secondary-200: {{ config('settings::theme:secondary-200-dark', '#18181B') }};
...
<body class="font-opensans bg-secondary-100 dark:bg-secondary-50 text-secondary-700">
